...
async def async_eval_comparative_breadth(report_markdown: str, query: str) -> tuple[float, str]:
    """Async: for comparison queries, check all entities get adequate treatment (LLM-as-judge)."""
    if not report_markdown or not query:
        return 0.5, "No report or query"
